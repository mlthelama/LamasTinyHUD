...
namespace handle {
    ...
    public:
        ...
        void init_edit(position_setting::position a_position);

        void set_hold_data(std::vector<data_helper*> a_data) const;

        [[nodiscard]] uint32_t get_page() const;
        [[nodiscard]] position_setting::position get_position() const;
    ...
    private:
        ...
        struct edit_handle_data {
            ...
            position_setting::position position = position_setting::position::total;
